<template>
    <form>
        ...
        <div class="form-group row">
            <label for="品种" class="col-sm-1">品种</label>
            <div class="col-sm-11">
                <input type="text" class="form-control" v-model="newPizza.name">
            </div>
        </div>
        <div class="form-group row">
            <label for="描述" class="col-sm-1">描述</label>
            <div class="col-sm-11">
        ...
        <div class="form-group row">
            <label for="尺寸" class="col-sm-1">尺寸</label>
            <div class="col-sm-11">
                <input type="text" class="form-control" v-model="newPizza.size1">
            </div>
        </div>
        <div class="form-group row">
            <label for="价格" class="col-sm-1">价格</label>
            <div class="col-sm-11">
        ...
        <div class="from-group row">
                <button @click="addMenuItem" type="button" class="btn btn-success btn-block">
                    添加
                </button>
        </div>
    </form>
...
export default {
  ...
  methods:{
      addMenuItem(){
        ...
        // fetch("https://pizza-app-7347d.firebaseio.com//menu.json",{
        //     method:"POST",
        //     headers:{
